...
paynow.resultUrl = "http://example.com/gateways/paynow/update"; // backend callback URL
paynow.returnUrl = "https://www.chikoro-ai.com"; 
...
app.post('/bhadhara', async (req, res) => {
  try {
    ...
    const amount = plan === 'basic' ? 0.01 : 15.00;
